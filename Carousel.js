...
const Carousel = () => {
  ...
  return (
    <div className="owl-carousel owl-theme w-[450px] font-iran ">
      <div className=" w-full text-center text-[13px] sm:pt-0 md:px-4 item flex flex-col ">
        <h3 className="mb-2 sm:py-0 md:py-4 font-semibold">تلفن پشتیبانی</h3>
        <img className="h-7 mb-2 " src={phonebook} />
